...
import {SegmentedControl, Segment} from '@igds/react/segmented-control';
import {Badge} from '@igds/react/badge';
  ...
  return (
    <>
      ...
      <SegmentedControl size="medium">
        ...
        <Segment selected>
          גנב הרוח של אדון המלחמה
        </Segment>
        <Segment>
          <Icon slot="icon" name="brush" />
